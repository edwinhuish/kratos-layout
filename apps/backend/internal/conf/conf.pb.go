...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\x80\x01\n" +
	"\x0ecom.kratos.apiB\tConfProtoP\x01Z\x1abackend/internal/conf;conf\xa2\x02\x03KAX\xaa\x02\n" +
	"Kratos.Api\xca\x02\n" +
